...
void main(){
    ...
    printf("Olá, sou a %s %s\n", nome, sobrenome);
        ...
        if(strncmp(nome, aderbaldo,2) == 0){
            printf("%s e %s comecam com a mesma letra\n", nome,  aderbaldo);
        } else{
            printf("%s e %s comecam com letras diferentes\n", nome,  aderbaldo);
        }
