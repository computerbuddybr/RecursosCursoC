...
Aqui vou apresentar a minha resolução para a atividade da faculdade da disciplina de Técnicas de Programação.

## Segue o enunciado original para que você tente antes de ver o resultado:
...
## Você encontra o código da solução [aqui](https://github.com/computerbuddybr/UAM-Tecnicas-de-Programacao-Atividades/blob/main/a3/a3.c)